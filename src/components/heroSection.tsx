export default function HeroSection() {
    return(
        <section className="mt-[350px] w-[83%] my-0 mx-[auto] max-lg:mt-[120px] max-md:mt-[30px]  ">
            <h1 className="text-[#ffffff] font-fira-code font-[700] 
            text-[75px] w-[70%] leading-[0.85] max-md:text-[25px]
            ...
            lg:text-[18px] max-md:text-[12px] ">Trade, earn, and own crypto on the all-in-one multi-chain DEX</p>
